#
#  Be sure to run `pod spec lint HHTimeProfiler.podspec' to ensure this is a
...
通过fishhook hook send_msg方法，将生成的文件。用chrome的chrome://tracing/工具打开显示火焰图。然后展示出函数调用栈和时间。
  ...
  spec.author             = { "hherima" => "hherima@126.com" }
  # Or just: spec.author    = "hherima"
  # spec.authors            = { "hherima" => "hherima@126.com" }
  # spec.social_media_url   = "https://blog.csdn.net/hherima"
  ...
  spec.source       = { :git => "https://github.com/hherima/HHTimeProfiler.git", :tag => '0.0.7'}
